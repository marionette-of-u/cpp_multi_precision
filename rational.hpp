...
namespace cpp_multi_precision{
    ...
    rational<RadixType, RadixLog2, Radix2Type, URadix2Type, Container, Allocator>
    operator +(
        typename rational<RadixType, RadixLog2, Radix2Type, URadix2Type, Container, Allocator>::integer_type &&lhs,
        const rational<RadixType, RadixLog2, Radix2Type, URadix2Type, Container, Allocator> &rhs
    ){ return static_cast<typename rational<RadixType, RadixLog2, Radix2Type, URadix2Type, Container, Allocator>::integer_type&>(lhs) + rhs; }
